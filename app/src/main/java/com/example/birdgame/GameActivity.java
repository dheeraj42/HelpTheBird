...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout = findViewById(R.id.conatraintLayout);
    ...
    public void collisionControl(){
        ...
        if(right > 0 && score < 200){
            if(right == 2){
                right1.setImageResource(R.drawable.health_);
            }
            if(right == 1){
                right2.setImageResource(R.drawable.health_);
            }
            ...
            handler.removeCallbacks(runnable);
            right3.setImageResource(R.drawable.health_);
